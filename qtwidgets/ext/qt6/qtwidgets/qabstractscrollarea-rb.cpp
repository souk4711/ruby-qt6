...
void Init_qabstractscrollarea(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQAbstractScrollArea =
        ...
        define_class_under<QAbstractScrollArea, QFrame>(rb_mQt6QtWidgets, "QAbstractScrollArea")
            ...
            .define_method("minimum_size_hint", &QAbstractScrollArea::minimumSizeHint)
            ...
            .define_method("set_horizontal_scroll_bar_policy", &QAbstractScrollArea::setHorizontalScrollBarPolicy, Arg(""))
            ...
            .define_method("set_vertical_scroll_bar_policy", &QAbstractScrollArea::setVerticalScrollBarPolicy, Arg(""))
            ...
            .define_method("size_hint", &QAbstractScrollArea::sizeHint)
