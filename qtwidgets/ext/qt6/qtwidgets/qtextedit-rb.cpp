...
void Init_qtextedit(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQTextEdit =
        ...
        define_class_under<QTextEdit, QAbstractScrollArea>(rb_mQt6QtWidgets, "QTextEdit")
            ...
            .define_method<QVariant (QTextEdit::*)(Qt::InputMethodQuery) const>("input_method_query", &QTextEdit::inputMethodQuery, Arg("property"))
            .define_method<QVariant (QTextEdit::*)(Qt::InputMethodQuery, QVariant) const>("input_method_query", &QTextEdit::inputMethodQuery, Arg("query"), Arg("argument"))
            ...
            .define_method("set_alignment", &QTextEdit::setAlignment, Arg("a"))
