...
void Init_qmenubar(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQMenuBar =
        ...
        define_class_under<QMenuBar, QWidget>(rb_mQt6QtWidgets, "QMenuBar")
            ...
            .define_method<QAction *(QMenuBar::*)(QMenu *)>("add_menu", &QMenuBar::addMenu, Arg("menu").takeOwnership())
            ...
            .define_method("set_corner_widget", &QMenuBar::setCornerWidget, Arg("widget").takeOwnership(), Arg("corner") = static_cast<Qt::Corner>(Qt::TopRightCorner))
