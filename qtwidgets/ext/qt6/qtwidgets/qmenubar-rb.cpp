...
Rice::Class rb_cQMenuBar;

void Init_qmenubar(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQMenuBar =
        ...
        define_class_under<QMenuBar, QWidget>(rb_mQt6QtWidgets, "QMenuBar")
            ...
            .define_method<QAction *(QMenuBar::*)(QMenu *)>("add_menu", &QMenuBar::addMenu, Arg("menu"))
            .define_method<QMenu *(QMenuBar::*)(const QIcon &, const QString &)>("add_menu", &QMenuBar::addMenu, Arg("icon"), Arg("title"))
            .define_method<QMenu *(QMenuBar::*)(const QString &)>("add_menu", &QMenuBar::addMenu, Arg("title"))
            ...
            .define_method("height_for_width", &QMenuBar::heightForWidth, Arg("w"))
            ...
            .define_method("minimum_size_hint", &QMenuBar::minimumSizeHint)
            .define_method("set_active_action", &QMenuBar::setActiveAction, Arg("action"))
            .define_method("set_corner_widget", &QMenuBar::setCornerWidget, Arg("w"), Arg("corner") = static_cast<Qt::Corner>(Qt::TopRightCorner))
            ...
            .define_method("size_hint", &QMenuBar::sizeHint)
            // Public Slots
