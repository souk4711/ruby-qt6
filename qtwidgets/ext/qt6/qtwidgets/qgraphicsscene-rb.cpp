...
void Init_qgraphicsscene(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQGraphicsScene =
        ...
        define_class_under<QGraphicsScene, QObject>(rb_mQt6QtWidgets, "QGraphicsScene")
            ...
            .define_method("add_item", &QGraphicsScene::addItem, Arg("item").takeOwnership())
            ...
            .define_method("add_widget", &QGraphicsScene::addWidget, Arg("widget").takeOwnership(), Arg("w_flags") = static_cast<Qt::WindowFlags>(Qt::WindowFlags()))
