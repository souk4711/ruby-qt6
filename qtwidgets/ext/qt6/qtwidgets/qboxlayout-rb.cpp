...
void Init_qboxlayout(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQBoxLayout =
        ...
        define_class_under<QBoxLayout, QLayout>(rb_mQt6QtWidgets, "QBoxLayout")
            ...
            .define_method("_add_layout", &QBoxLayout::addLayout, Arg("layout"), Arg("stretch") = static_cast<int>(0))
            .define_method("_add_spacer_item", &QBoxLayout::addSpacerItem, Arg("item"))
            ...
            .define_method("_add_widget", &QBoxLayout::addWidget, Arg("widget"), Arg("stretch") = static_cast<int>(0), Arg("alignment") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method("_insert_item", &QBoxLayout::insertItem, Arg("index"), Arg("item"))
            .define_method("_insert_layout", &QBoxLayout::insertLayout, Arg("index"), Arg("layout"), Arg("stretch") = static_cast<int>(0))
            .define_method("_insert_spacer_item", &QBoxLayout::insertSpacerItem, Arg("index"), Arg("item"))
            ...
            .define_method("_insert_widget", &QBoxLayout::insertWidget, Arg("index"), Arg("widget"), Arg("stretch") = static_cast<int>(0), Arg("alignment") = static_cast<Qt::Alignment>(Qt::Alignment()))
