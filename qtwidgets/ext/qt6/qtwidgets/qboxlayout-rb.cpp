...
void Init_QBoxLayout(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQBoxLayout =
        ...
        define_class_under<QBoxLayout, QLayout>(rb_mQt6QtWidgets, "QBoxLayout")
            ...
            .define_method("add_widget", &QBoxLayout::addWidget, Arg(""), Arg("stretch") = static_cast<int>(0), Arg("alignment") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method("direction", &QBoxLayout::direction)
            .define_method("insert_item", &QBoxLayout::insertItem, Arg("index"), Arg(""))
            .define_method("insert_layout", &QBoxLayout::insertLayout, Arg("index"), Arg("layout"), Arg("stretch") = static_cast<int>(0))
            .define_method("insert_spacer_item", &QBoxLayout::insertSpacerItem, Arg("index"), Arg("spacer_item"))
