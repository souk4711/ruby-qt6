...
void Init_qgridlayout(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQGridLayout =
        ...
        define_class_under<QGridLayout, QLayout>(rb_mQt6QtWidgets, "QGridLayout")
            ...
            // Public Functions
            .define_method<void (QGridLayout::*)(QLayoutItem *, int, int, int, int, Qt::Alignment)>("add_item", &QGridLayout::addItem, Arg("item"), Arg("row"), Arg("column"), Arg("row_span") = static_cast<int>(1), Arg("column_span") = static_cast<int>(1), Arg("") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method<void (QGridLayout::*)(QLayout *, int, int, Qt::Alignment)>("add_layout", &QGridLayout::addLayout, Arg(""), Arg("row"), Arg("column"), Arg("") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method<void (QGridLayout::*)(QLayout *, int, int, int, int, Qt::Alignment)>("add_layout", &QGridLayout::addLayout, Arg(""), Arg("row"), Arg("column"), Arg("row_span"), Arg("column_span"), Arg("") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method<void (QGridLayout::*)(QWidget *)>("add_widget", &QGridLayout::addWidget, Arg("w"))
            .define_method<void (QGridLayout::*)(QWidget *, int, int, Qt::Alignment)>("add_widget", &QGridLayout::addWidget, Arg(""), Arg("row"), Arg("column"), Arg("") = static_cast<Qt::Alignment>(Qt::Alignment()))
            .define_method<void (QGridLayout::*)(QWidget *, int, int, int, int, Qt::Alignment)>("add_widget", &QGridLayout::addWidget, Arg(""), Arg("row"), Arg("column"), Arg("row_span"), Arg("column_span"), Arg("") = static_cast<Qt::Alignment>(Qt::Alignment()))
