...
void Init_qlistwidget(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQListWidget =
        ...
        define_class_under<QListWidget, QListView>(rb_mQt6QtWidgets, "QListWidget")
            ...
            // Public Functions
            .define_method<void (QListWidget::*)(QListWidgetItem *)>("_add_item", &QListWidget::addItem, Arg("item"))
            ...
            .define_method<void (QListWidget::*)(int, QListWidgetItem *)>("insert_item", &QListWidget::insertItem, Arg("row"), Arg("item"))
            ...
            .define_method("take_item", &QListWidget::takeItem, Arg("row"))
