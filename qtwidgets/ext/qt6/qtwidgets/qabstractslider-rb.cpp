...
void Init_qabstractslider(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQAbstractSlider =
        ...
        define_class_under<QAbstractSlider, QWidget>(rb_mQt6QtWidgets, "QAbstractSlider")
            ...
            .define_method("_set_inverted_appearance", &QAbstractSlider::setInvertedAppearance, Arg("enabled"))
            .define_method("_set_inverted_controls", &QAbstractSlider::setInvertedControls, Arg("enabled"))
            ...
            .define_method("_set_page_step", &QAbstractSlider::setPageStep, Arg("step"))
            .define_method("_set_single_step", &QAbstractSlider::setSingleStep, Arg("step"))
            .define_method("_set_slider_down", &QAbstractSlider::setSliderDown, Arg("down"))
            .define_method("_set_slider_position", &QAbstractSlider::setSliderPosition, Arg("position"))
            .define_method("_set_tracking", &QAbstractSlider::setTracking, Arg("enabled"))
