...
void Init_qmainwindow(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQMainWindow =
        ...
        define_class_under<QMainWindow, QWidget>(rb_mQt6QtWidgets, "QMainWindow")
            ...
            .define_method("set_central_widget", &QMainWindow::setCentralWidget, Arg("widget").takeOwnership())
            ...
            .define_method("set_menu_bar", &QMainWindow::setMenuBar, Arg("menubar").takeOwnership())
            .define_method("set_menu_widget", &QMainWindow::setMenuWidget, Arg("menubar").takeOwnership())
            .define_method("set_status_bar", &QMainWindow::setStatusBar, Arg("statusbar").takeOwnership())
            ...
            .define_method("take_central_widget", &QMainWindow::takeCentralWidget, Return().takeOwnership())
