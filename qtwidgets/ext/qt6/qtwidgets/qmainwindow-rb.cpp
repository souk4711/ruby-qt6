...
void Init_qmainwindow(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQMainWindow =
        ...
        define_class_under<QMainWindow, QWidget>(rb_mQt6QtWidgets, "QMainWindow")
            ...
            .define_method<void (QMainWindow::*)(QToolBar *)>("add_tool_bar", &QMainWindow::addToolBar, Arg("toolbar"))
            .define_method<void (QMainWindow::*)(Qt::ToolBarArea, QToolBar *)>("add_tool_bar", &QMainWindow::addToolBar, Arg("area"), Arg("toolbar"))
