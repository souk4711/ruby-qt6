...
void Init_qtableview(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQTableView =
        ...
        define_class_under<QTableView, QAbstractItemView>(rb_mQt6QtWidgets, "QTableView")
            ...
            .define_method("set_horizontal_header", &QTableView::setHorizontalHeader, Arg("header").takeOwnership())
            ...
            .define_method("set_vertical_header", &QTableView::setVerticalHeader, Arg("header").takeOwnership())
