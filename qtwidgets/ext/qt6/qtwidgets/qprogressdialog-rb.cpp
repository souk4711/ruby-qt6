...
void Init_qprogressdialog(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQProgressDialog =
        ...
        define_class_under<QProgressDialog, QDialog>(rb_mQt6QtWidgets, "QProgressDialog")
            ...
            .define_method("set_bar", &QProgressDialog::setBar, Arg("bar").takeOwnership())
            .define_method("set_cancel_button", &QProgressDialog::setCancelButton, Arg("button").takeOwnership())
            .define_method("set_label", &QProgressDialog::setLabel, Arg("label").takeOwnership())
