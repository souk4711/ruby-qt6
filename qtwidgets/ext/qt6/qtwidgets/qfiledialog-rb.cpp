...
void Init_qfiledialog(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQFileDialog =
        ...
        define_class_under<QFileDialog, QDialog>(rb_mQt6QtWidgets, "QFileDialog")
            ...
            .define_method("set_icon_provider", &QFileDialog::setIconProvider, Arg("provider").takeOwnership())
            ...
            .define_method("set_proxy_model", &QFileDialog::setProxyModel, Arg("model").takeOwnership())
