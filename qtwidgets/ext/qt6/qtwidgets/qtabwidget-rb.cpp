...
void Init_qtabwidget(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQTabWidget =
        ...
        define_class_under<QTabWidget, QWidget>(rb_mQt6QtWidgets, "QTabWidget")
            ...
            .define_method("has_height_for_width", &QTabWidget::hasHeightForWidth)
            .define_method("height_for_width", &QTabWidget::heightForWidth, Arg("width"))
            ...
            .define_method("minimum_size_hint", &QTabWidget::minimumSizeHint)
            .define_method("remove_tab", &QTabWidget::removeTab, Arg("index"))
            .define_method("set_corner_widget", &QTabWidget::setCornerWidget, Arg("w"), Arg("corner") = static_cast<Qt::Corner>(Qt::TopRightCorner))
            ...
            .define_method("size_hint", &QTabWidget::sizeHint)
