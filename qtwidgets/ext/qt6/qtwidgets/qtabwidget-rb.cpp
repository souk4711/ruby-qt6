...
void Init_qtabwidget(Module rb_mQt6QtWidgets)
{
    rb_cQTabWidget =
        ...
        define_class_under<QTabWidget, QWidget>(rb_mQt6QtWidgets, "QTabWidget")
            ...
            .define_method<int (QTabWidget::*)(int, QWidget *, const QIcon &, const QString &)>("insert_tab", &QTabWidget::insertTab, Arg("index"), Arg("widget"), Arg("icon"), Arg("label"))
            .define_method<int (QTabWidget::*)(int, QWidget *, const QString &)>("insert_tab", &QTabWidget::insertTab, Arg("index"), Arg("widget"), Arg("label"))
            ...
            .define_method("set_corner_widget", &QTabWidget::setCornerWidget, Arg("widget"), Arg("corner") = static_cast<Qt::Corner>(Qt::TopRightCorner))
