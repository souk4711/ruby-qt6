...
void Init_qspinbox(Module rb_mQt6QtWidgets)
{
    rb_cQDoubleSpinBox =
        ...
        define_class_under<QDoubleSpinBox, QAbstractSpinBox>(rb_mQt6QtWidgets, "QDoubleSpinBox")
            ...
            .define_method("_set_prefix", &QDoubleSpinBox::setPrefix, Arg("prefix"))
            ...
            .define_method("_set_suffix", &QDoubleSpinBox::setSuffix, Arg("suffix"))
    ...
    rb_cQSpinBox =
        ...
        define_class_under<QSpinBox, QAbstractSpinBox>(rb_mQt6QtWidgets, "QSpinBox")
            ...
            .define_method("_set_prefix", &QSpinBox::setPrefix, Arg("prefix"))
            ...
            .define_method("_set_suffix", &QSpinBox::setSuffix, Arg("suffix"))
