...
void Init_qabstractbutton(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQAbstractButton =
        ...
        define_class_under<QAbstractButton, QWidget>(rb_mQt6QtWidgets, "QAbstractButton")
            ...
            .define_method("_set_auto_exclusive", &QAbstractButton::setAutoExclusive, Arg("b"))
            .define_method("_set_auto_repeat", &QAbstractButton::setAutoRepeat, Arg("b"))
            .define_method("_set_auto_repeat_delay", &QAbstractButton::setAutoRepeatDelay, Arg("i"))
            .define_method("_set_auto_repeat_interval", &QAbstractButton::setAutoRepeatInterval, Arg("i"))
            .define_method("_set_checkable", &QAbstractButton::setCheckable, Arg("b"))
            .define_method("_set_checked", &QAbstractButton::setChecked, Arg("b"))
            .define_method("_set_down", &QAbstractButton::setDown, Arg("b"))
