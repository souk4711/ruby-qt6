...
void Init_qmenu(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQMenu =
        ...
        define_class_under<QMenu, QWidget>(rb_mQt6QtWidgets, "QMenu")
            ...
            .define_method<QAction *(QMenu::*)(QMenu *)>("add_menu", &QMenu::addMenu, Arg("menu").takeOwnership())
            ...
            .define_method("insert_menu", &QMenu::insertMenu, Arg("before"), Arg("menu").takeOwnership())
