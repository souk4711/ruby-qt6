...
void Init_qtoolbox(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQToolBox =
        ...
        define_class_under<QToolBox, QFrame>(rb_mQt6QtWidgets, "QToolBox")
            ...
            // Public Functions
            .define_method<int (QToolBox::*)(QWidget *, const QIcon &, const QString &)>("add_item", &QToolBox::addItem, Arg("item").takeOwnership(), Arg("icon"), Arg("text"))
            .define_method<int (QToolBox::*)(QWidget *, const QString &)>("add_item", &QToolBox::addItem, Arg("item").takeOwnership(), Arg("text"))
            ...
            .define_method<int (QToolBox::*)(int, QWidget *, const QIcon &, const QString &)>("insert_item", &QToolBox::insertItem, Arg("index"), Arg("item").takeOwnership(), Arg("icon"), Arg("text"))
            .define_method<int (QToolBox::*)(int, QWidget *, const QString &)>("insert_item", &QToolBox::insertItem, Arg("index"), Arg("item").takeOwnership(), Arg("text"))
