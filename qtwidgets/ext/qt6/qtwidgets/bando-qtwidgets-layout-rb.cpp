...
void Init_bando_qtwidgets_layout(Rice::Module rb_mQt6Bando)
{
    ...
    rb_mBando_cQBoxLayout =
        define_bando_qlayout_under<Bando_QBoxLayout, QBoxLayout>(rb_mQt6Bando, "QBoxLayout")
    ...
    rb_mBando_cQHBoxLayout =
        define_bando_qlayout_under<Bando_QHBoxLayout, QHBoxLayout>(rb_mQt6Bando, "QHBoxLayout")
            .define_constructor(Constructor<Bando_QHBoxLayout, QWidget *>(), Arg("parent"));

    rb_mBando_cQVBoxLayout =
        define_bando_qlayout_under<Bando_QVBoxLayout, QVBoxLayout>(rb_mQt6Bando, "QVBoxLayout")
            .define_constructor(Constructor<Bando_QVBoxLayout, QWidget *>(), Arg("parent"));

    rb_mBando_cQFormLayout =
        define_bando_qlayout_under<Bando_QFormLayout, QFormLayout>(rb_mQt6Bando, "QFormLayout")
            .define_constructor(Constructor<Bando_QFormLayout, QWidget *>(), Arg("parent"));

    rb_mBando_cQGridLayout =
        define_bando_qlayout_under<Bando_QGridLayout, QGridLayout>(rb_mQt6Bando, "QGridLayout")
            .define_constructor(Constructor<Bando_QGridLayout, QWidget *>(), Arg("parent"));

    rb_mBando_cQStackedLayout =
        define_bando_qlayout_under<Bando_QStackedLayout, QStackedLayout>(rb_mQt6Bando, "QStackedLayout")
