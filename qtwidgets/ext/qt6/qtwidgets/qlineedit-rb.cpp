...
void Init_qlineedit(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQLineEdit =
        ...
        define_class_under<QLineEdit, QWidget>(rb_mQt6QtWidgets, "QLineEdit")
            ...
            .define_method("set_alignment", [](QLineEdit *self, Qt::AlignmentFlag alignment) -> void { return self->setAlignment(alignment); }, Arg("alignment"))
            ...
            .define_method<void (QLineEdit::*)(QAction *, QLineEdit::ActionPosition)>("add_action", &QLineEdit::addAction, Arg("action").takeOwnership(), Arg("position"))
            ...
            .define_method("set_alignment", &QLineEdit::setAlignment, Arg("alignment"))
            .define_method("set_clear_button_enabled", &QLineEdit::setClearButtonEnabled, Arg("enable"))
            .define_method("set_completer", &QLineEdit::setCompleter, Arg("completer").takeOwnership())
            ...
            .define_method("set_validator", &QLineEdit::setValidator, Arg("validator").takeOwnership())
