...
void Init_qlineedit(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQLineEdit =
        ...
        define_class_under<QLineEdit, QWidget>(rb_mQt6QtWidgets, "QLineEdit")
            ...
            .define_method<QVariant (QLineEdit::*)(Qt::InputMethodQuery) const>("input_method_query", &QLineEdit::inputMethodQuery, Arg(""))
            ...
            .define_method("set_cursor_position", &QLineEdit::setCursorPosition, Arg(""))
            ...
            .define_method("set_validator", &QLineEdit::setValidator, Arg(""))
