...
void Init_qabstractspinbox(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQAbstractSpinBox =
        ...
        define_class_under<QAbstractSpinBox, QWidget>(rb_mQt6QtWidgets, "QAbstractSpinBox")
            ...
            .define_method("input_method_query", &QAbstractSpinBox::inputMethodQuery, Arg("query"))
            ...
            .define_method("minimum_size_hint", &QAbstractSpinBox::minimumSizeHint)
            ...
            .define_method("size_hint", &QAbstractSpinBox::sizeHint)
