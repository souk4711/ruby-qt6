...
void Init_qtreewidget(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQTreeWidget =
        ...
        define_class_under<QTreeWidget, QTreeView>(rb_mQt6QtWidgets, "QTreeWidget")
            ...
            // Public Functions
            .define_method("add_top_level_item", &QTreeWidget::addTopLevelItem, Arg("item").takeOwnership())
            ...
            .define_method("insert_top_level_item", &QTreeWidget::insertTopLevelItem, Arg("index"), Arg("item").takeOwnership())
            ...
            .define_method("set_header_item", &QTreeWidget::setHeaderItem, Arg("item").takeOwnership())
            ...
            .define_method("set_item_widget", &QTreeWidget::setItemWidget, Arg("item"), Arg("column"), Arg("widget").takeOwnership())
            ...
            .define_method("take_top_level_item", &QTreeWidget::takeTopLevelItem, Arg("index"), Return().takeOwnership())
    ...
    rb_cQTreeWidgetItem =
        ...
        define_class_under<QTreeWidgetItem>(rb_mQt6QtWidgets, "QTreeWidgetItem")
            // Constructor
            .define_constructor(Constructor<QTreeWidgetItem, int>(), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidget *, int>(), Arg("treeview"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidgetItem *, int>(), Arg("parent"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidget *, QTreeWidgetItem *, int>(), Arg("treeview"), Arg("after"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidgetItem *, QTreeWidgetItem *, int>(), Arg("parent"), Arg("after"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, const QStringList &, int>(), Arg("strings"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidget *, const QStringList &, int>(), Arg("treeview"), Arg("strings"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            .define_constructor(Constructor<QTreeWidgetItem, QTreeWidgetItem *, const QStringList &, int>(), Arg("parent"), Arg("strings"), Arg("type") = static_cast<int>(QTreeWidgetItem::ItemType::Type))
            // Public Functions
            .define_method("add_child", &QTreeWidgetItem::addChild, Arg("child").takeOwnership())
            ...
            .define_method("insert_child", &QTreeWidgetItem::insertChild, Arg("index"), Arg("child").takeOwnership())
            ...
            .define_method("size_hint", &QTreeWidgetItem::sizeHint, Arg("column"))
            ...
            .define_method("take_child", &QTreeWidgetItem::takeChild, Arg("index"), Return().takeOwnership())
