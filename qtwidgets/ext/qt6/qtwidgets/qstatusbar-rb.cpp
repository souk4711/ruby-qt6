...
void Init_qstatusbar(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQStatusBar =
        ...
        define_class_under<QStatusBar, QWidget>(rb_mQt6QtWidgets, "QStatusBar")
            ...
            // Public Functions
            .define_method("add_permanent_widget", &QStatusBar::addPermanentWidget, Arg("widget").takeOwnership(), Arg("stretch") = static_cast<int>(0))
            .define_method("add_widget", &QStatusBar::addWidget, Arg("widget").takeOwnership(), Arg("stretch") = static_cast<int>(0))
            .define_method("current_message", &QStatusBar::currentMessage)
            .define_method("insert_permanent_widget", &QStatusBar::insertPermanentWidget, Arg("index"), Arg("widget").takeOwnership(), Arg("stretch") = static_cast<int>(0))
            .define_method("insert_widget", &QStatusBar::insertWidget, Arg("index"), Arg("widget").takeOwnership(), Arg("stretch") = static_cast<int>(0))
