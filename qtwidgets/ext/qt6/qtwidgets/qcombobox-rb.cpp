...
void Init_qcombobox(Module rb_mQt6QtWidgets)
{
    rb_cQComboBox =
        ...
        define_qlass_under<QComboBox, QWidget>(rb_mQt6QtWidgets, "QComboBox")
            ...
            .define_method<void (QComboBox::*)(int, const QIcon &, const QString &, const QVariant &)>("_insert_item", &QComboBox::insertItem, Arg("index"), Arg("icon"), Arg("text"), Arg("user_data") = static_cast<const QVariant &>(QVariant()))
            .define_method<void (QComboBox::*)(int, const QString &, const QVariant &)>("_insert_item", &QComboBox::insertItem, Arg("index"), Arg("text"), Arg("user_data") = static_cast<const QVariant &>(QVariant()))
            ...
            .define_method("_set_item_text", &QComboBox::setItemText, Arg("index"), Arg("text"))
