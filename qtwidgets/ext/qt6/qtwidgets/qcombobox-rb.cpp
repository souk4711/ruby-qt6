...
void Init_qcombobox(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQComboBox =
        ...
        define_class_under<QComboBox, QWidget>(rb_mQt6QtWidgets, "QComboBox")
            ...
            .define_method<QVariant (QComboBox::*)(Qt::InputMethodQuery) const>("input_method_query", &QComboBox::inputMethodQuery, Arg("query"))
            .define_method<QVariant (QComboBox::*)(Qt::InputMethodQuery, const QVariant &) const>("input_method_query", &QComboBox::inputMethodQuery, Arg("query"), Arg("argument"))
            ...
            .define_method("minimum_size_hint", &QComboBox::minimumSizeHint)
            ...
            .define_method("size_hint", &QComboBox::sizeHint)
