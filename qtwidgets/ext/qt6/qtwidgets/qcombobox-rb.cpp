...
void Init_qcombobox(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQComboBox =
        ...
        define_class_under<QComboBox, QWidget>(rb_mQt6QtWidgets, "QComboBox")
            ...
            .define_method("find_text", &QComboBox::findText, Arg("text"), Arg("flags") = static_cast<Qt::MatchFlags>(static_cast<Qt::MatchFlags>(Qt::MatchExactly | Qt::MatchCaseSensitive)))
            ...
            .define_method("set_completer", &QComboBox::setCompleter, Arg("c").takeOwnership())
            ...
            .define_method("set_item_delegate", &QComboBox::setItemDelegate, Arg("delegate").takeOwnership())
            ...
            .define_method("set_line_edit", &QComboBox::setLineEdit, Arg("edit").takeOwnership())
            ...
            .define_method("set_validator", &QComboBox::setValidator, Arg("v").takeOwnership())
            .define_method("set_view", &QComboBox::setView, Arg("item_view").takeOwnership())
