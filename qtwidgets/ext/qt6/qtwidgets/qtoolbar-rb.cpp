...
void Init_qtoolbar(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQToolBar =
        ...
        define_class_under<QToolBar, QWidget>(rb_mQt6QtWidgets, "QToolBar")
            ...
            .define_method("add_widget", &QToolBar::addWidget, Arg("widget").takeOwnership())
            ...
            .define_method("insert_widget", &QToolBar::insertWidget, Arg("before"), Arg("widget").takeOwnership())
