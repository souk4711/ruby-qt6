...
void Init_qtabbar(Module rb_mQt6QtWidgets)
{
    rb_cQTabBar =
        ...
        define_class_under<QTabBar, QWidget>(rb_mQt6QtWidgets, "QTabBar")
            ...
            .define_method<int (QTabBar::*)(const QIcon &, const QString &)>("_add_tab", &QTabBar::addTab, Arg("icon"), Arg("text"))
            .define_method<int (QTabBar::*)(const QString &)>("_add_tab", &QTabBar::addTab, Arg("text"))
