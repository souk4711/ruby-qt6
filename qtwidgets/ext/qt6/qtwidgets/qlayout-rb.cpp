...
void Init_qlayout(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQLayout =
        ...
        define_class_under<QLayout, QObject>(rb_mQt6QtWidgets, "QLayout")
            ...
            .define_method("add_item", &QLayout::addItem, Arg("item"))
            .define_method("add_widget", &QLayout::addWidget, Arg("widget"))
            ...
            .define_method("remove_item", &QLayout::removeItem, Arg("item"))
            .define_method("remove_widget", &QLayout::removeWidget, Arg("widget"))
