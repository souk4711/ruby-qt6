...
void Init_qlayout(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQLayout =
        ...
        define_class_under<QLayout, QObject>(rb_mQt6QtWidgets, "QLayout")
            ...
            .define_method("height_for_width", &QLayout::heightForWidth, Arg(""))
            ...
            .define_method("minimum_height_for_width", &QLayout::minimumHeightForWidth, Arg(""))
            ...
            .define_method("add_widget", &QLayout::addWidget, Arg("w").takeOwnership())
