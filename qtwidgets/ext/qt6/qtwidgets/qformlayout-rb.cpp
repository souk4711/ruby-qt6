...
void Init_qformlayout(Module rb_mQt6QtWidgets)
{
    rb_cQFormLayout =
        ...
        define_class_under<QFormLayout, QLayout>(rb_mQt6QtWidgets, "QFormLayout")
            ...
            .define_method<void (QFormLayout::*)(QLayout *)>("add_row", &QFormLayout::addRow, Arg("field"))
            .define_method<void (QFormLayout::*)(QWidget *)>("add_row", &QFormLayout::addRow, Arg("field"))
            .define_method<void (QFormLayout::*)(QWidget *, QLayout *)>("add_row", &QFormLayout::addRow, Arg("label"), Arg("field"))
            .define_method<void (QFormLayout::*)(QWidget *, QWidget *)>("add_row", &QFormLayout::addRow, Arg("label"), Arg("field"))
            .define_method<void (QFormLayout::*)(const QString &, QLayout *)>("add_row", &QFormLayout::addRow, Arg("label_text"), Arg("field"))
            .define_method<void (QFormLayout::*)(const QString &, QWidget *)>("add_row", &QFormLayout::addRow, Arg("label_text"), Arg("field"))
            ...
            .define_method<void (QFormLayout::*)(int, QLayout *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("field"))
            .define_method<void (QFormLayout::*)(int, QWidget *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("field"))
            .define_method<void (QFormLayout::*)(int, QWidget *, QLayout *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("label"), Arg("field"))
            .define_method<void (QFormLayout::*)(int, QWidget *, QWidget *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("label"), Arg("field"))
            .define_method<void (QFormLayout::*)(int, const QString &, QLayout *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("label_text"), Arg("field"))
            .define_method<void (QFormLayout::*)(int, const QString &, QWidget *)>("insert_row", &QFormLayout::insertRow, Arg("row"), Arg("label_text"), Arg("field"))
