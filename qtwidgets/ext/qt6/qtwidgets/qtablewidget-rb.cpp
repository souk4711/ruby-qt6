...
void Init_qtablewidget(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQTableWidget =
        ...
        define_class_under<QTableWidget, QTableView>(rb_mQt6QtWidgets, "QTableWidget")
            ...
            .define_method("set_cell_widget", &QTableWidget::setCellWidget, Arg("row"), Arg("column"), Arg("widget").takeOwnership())
            ...
            .define_method("set_horizontal_header_item", &QTableWidget::setHorizontalHeaderItem, Arg("column"), Arg("item").takeOwnership())
            .define_method("set_horizontal_header_labels", &QTableWidget::setHorizontalHeaderLabels, Arg("labels"))
            .define_method("set_item", &QTableWidget::setItem, Arg("row"), Arg("column"), Arg("item").takeOwnership())
            .define_method("set_item_prototype", &QTableWidget::setItemPrototype, Arg("item").takeOwnership())
            ...
            .define_method("set_vertical_header_item", &QTableWidget::setVerticalHeaderItem, Arg("row"), Arg("item").takeOwnership())
            ...
            .define_method("take_horizontal_header_item", &QTableWidget::takeHorizontalHeaderItem, Arg("column"), Return().takeOwnership())
            .define_method("take_item", &QTableWidget::takeItem, Arg("row"), Arg("column"), Return().takeOwnership())
            .define_method("take_vertical_header_item", &QTableWidget::takeVerticalHeaderItem, Arg("row"), Return().takeOwnership())
    ...
    rb_cQTableWidgetItem =
        ...
        define_class_under<QTableWidgetItem>(rb_mQt6QtWidgets, "QTableWidgetItem")
            ...
            .define_method("set_flags", &QTableWidgetItem::setFlags, Arg("flags"))
            ...
            .define_method("size_hint", &QTableWidgetItem::sizeHint)
