...
void Init_qsplitter(Rice::Module rb_mQt6QtWidgets)
{
    rb_cQSplitter =
        ...
        define_class_under<QSplitter, QFrame>(rb_mQt6QtWidgets, "QSplitter")
            ...
            // Public Functions
            .define_method("add_widget", &QSplitter::addWidget, Arg("widget").takeOwnership())
            ...
            .define_method("insert_widget", &QSplitter::insertWidget, Arg("index"), Arg("widget").takeOwnership())
            .define_method("collapsible?", &QSplitter::isCollapsible, Arg("index"))
            .define_method("minimum_size_hint", &QSplitter::minimumSizeHint)
            ...
            .define_method("size_hint", &QSplitter::sizeHint)
    ...
    rb_cQSplitterHandle =
        ...
        define_class_under<QSplitterHandle, QWidget>(rb_mQt6QtWidgets, "QSplitterHandle")
            ...
            .define_method("size_hint", &QSplitterHandle::sizeHint)
