...
class Window < RubyQt6::Bando::QMainWindow
  ...
  def initialize
    ...
    help_menu = self.menu_bar.add_menu(tr("&Help"))
...
puts "Launch with `LANG=de bundle exec ruby main.rb` to load example_de.qm" unless translator_custom.load(QLocale.system, "example", "_", ":/translations")
