...
void Init_qquickpainteditem(Rice::Module rb_mQt6QtQuick)
{
    rb_cQQuickPaintedItem =
        ...
        define_class_under<QQuickPaintedItem, QQuickItem>(rb_mQt6QtQuick, "QQuickPaintedItem")
            ...
            .define_method("set_fill_color", &QQuickPaintedItem::setFillColor, Arg("color"))
            ...
            .define_method("set_antialiasing", &QQuickPaintedItem::setAntialiasing, Arg("enabled"))
            .define_method("set_mipmap", &QQuickPaintedItem::setMipmap, Arg("enabled"))
