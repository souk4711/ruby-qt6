...
require_relative "lib/qt6/rspec/version"

Gem::Specification.new do |spec|
  spec.name = "ruby-qt6-rspec"
  spec.version = RubyQt6::RSpec::RSPEC_RUBYGEM_VERSION
  spec.authors = ["John Doe"]
  spec.email = ["johndoe@example.com"]

  spec.summary = "RSpec for RubyQt6."
  spec.description = "RSpec for RubyQt6."
