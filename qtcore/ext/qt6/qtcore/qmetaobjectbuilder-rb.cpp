...
void Init_qmetaobjectbuilder(Rice::Module rb_mQt6QtCore)
{
    rb_cQMetaObjectBuilder =
        ...
        define_class_under<QMetaObjectBuilder>(rb_mQt6QtCore, "QMetaObjectBuilder")
            ...
            // Public Functions
            .define_method("add_class_info", &QMetaObjectBuilder::addClassInfo, Arg("name"), Arg("value"))
            ...
            .define_method("add_signal", &QMetaObjectBuilder::addSignal, Arg("signature"))
            .define_method("add_slot", &QMetaObjectBuilder::addSlot, Arg("signature"))
            ...
            .define_method("set_class_name", &QMetaObjectBuilder::setClassName, Arg("name"))
            .define_method("set_flags", &QMetaObjectBuilder::setFlags, Arg(""))
    ...
    rb_cQMetaMethodBuilder =
        ...
        define_class_under<QMetaMethodBuilder>(rb_mQt6QtCore, "QMetaMethodBuilder")
            ...
            .define_method("is_const", &QMetaMethodBuilder::isConst)
            ...
            .define_method("set_return_type", &QMetaMethodBuilder::setReturnType, Arg("value"))
