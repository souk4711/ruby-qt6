...
void Init_qcoreapplication(Rice::Module rb_mQt6QtCore)
{
    rb_cQCoreApplication =
        ...
        define_class_under<QCoreApplication, QObject>(rb_mQt6QtCore, "QCoreApplication")
            ...
            .define_singleton_function("set_application_name", &QCoreApplication::setApplicationName, Arg("name"))
            .define_singleton_function("set_application_version", &QCoreApplication::setApplicationVersion, Arg("version"))
            .define_singleton_function("set_organization_domain", &QCoreApplication::setOrganizationDomain, Arg("domain"))
            .define_singleton_function("set_organization_name", &QCoreApplication::setOrganizationName, Arg("name"))
            ...
            .define_method("install_native_event_filter", &QCoreApplication::installNativeEventFilter, Arg("filter"))
            .define_method("notify", &QCoreApplication::notify, Arg("receiver"), Arg("event"))
            .define_method("remove_native_event_filter", &QCoreApplication::removeNativeEventFilter, Arg("filter"))
            // Public Slots
            ...
            .define_singleton_function("install_translator", &QCoreApplication::installTranslator, Arg("translator"))
            ...
            .define_singleton_function("post_event", &QCoreApplication::postEvent, Arg("receiver"), Arg("event").takeOwnership(), Arg("priority") = static_cast<int>(Qt::NormalEventPriority))
            ...
            .define_singleton_function("remove_translator", &QCoreApplication::removeTranslator, Arg("translator"))
            ...
            .define_singleton_function("set_event_dispatcher", &QCoreApplication::setEventDispatcher, Arg("event_dispatcher").takeOwnership())
            .define_singleton_function("set_library_paths", &QCoreApplication::setLibraryPaths, Arg("paths"))
