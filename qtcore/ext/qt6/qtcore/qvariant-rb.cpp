...
void Init_qvariant(Rice::Module rb_mQt6QtCore)
{
    rb_cQVariant =
        ...
        define_class_under<QVariant>(rb_mQt6QtCore, "QVariant")
            ...
            .define_method("to_longlong", &QVariant::toLongLong, Arg("ok") = static_cast<bool *>(nullptr))
            ...
            .define_method("to_uint", &QVariant::toUInt, Arg("ok") = static_cast<bool *>(nullptr))
            .define_method("to_ulonglong", &QVariant::toULongLong, Arg("ok") = static_cast<bool *>(nullptr))
