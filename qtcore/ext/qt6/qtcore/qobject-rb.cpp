...
void Init_qobject(Rice::Module rb_mQt6QtCore)
{
    rb_cQObject =
        ...
        define_class_under<QObject>(rb_mQt6QtCore, "QObject")
            ...
            // TODO: .define_method("set_object_name", &QObject::setObjectName, Arg("name"))
            .define_method("bindable_object_name", &QObject::bindableObjectName)
            .define_method("is_widget_type", &QObject::isWidgetType)
            .define_method("is_window_type", &QObject::isWindowType)
            .define_method("is_quick_item_type", &QObject::isQuickItemType)
