...
void Init_qobject(Rice::Module rb_mQt6QtCore)
{
    rb_cQObject =
        ...
        define_class_under<QObject>(rb_mQt6QtCore, "QObject")
            ...
            .define_method("block_signals", &QObject::blockSignals, Arg("block"))
            ...
            .define_method("install_event_filter", &QObject::installEventFilter, Arg("filter"))
            ...
            .define_method("remove_event_filter", &QObject::removeEventFilter, Arg("filter"))
            ...
            // Signals
            .define_method("destroyed", &QObject::destroyed, Arg("object") = static_cast<QObject *>(nullptr))
            .define_method("object_name_changed", &QObject::objectNameChanged, Arg("object_name"), Arg("name"))
