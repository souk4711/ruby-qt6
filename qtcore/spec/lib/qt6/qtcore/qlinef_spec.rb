RSpec.describe RubyQt6::QtCore::QLineF do
  it "#initialize" do
    ...
    p1 = RubyQt6::QtCore::QPointF.new(1, 2)
    p2 = RubyQt6::QtCore::QPointF.new(3, 4)
  ...
  it "#==" do
    ...
    expect(described_class.new(1.0, 2.0, 3.0, 4.0)).to eq(RubyQt6::QtCore::QLine.new(1, 2, 3, 4))
    expect(described_class.new(1.0, 2.0, 3.0, 4.0)).not_to eq(RubyQt6::QtCore::QLine.new(1, 2, 3, 5))
