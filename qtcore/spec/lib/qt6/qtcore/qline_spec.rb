RSpec.describe QLine do
  ...
  it "#==" do
    ...
    expect(described_class.new(1, 2, 3, 4)).to eq(QLineF.new(1.0, 2.0, 3.0, 4.0))
    expect(described_class.new(1, 2, 3, 4)).not_to eq(QLineF.new(1.0, 2.0, 3.0, 4.1))
