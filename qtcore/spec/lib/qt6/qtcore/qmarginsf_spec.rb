RSpec.describe QMarginsF do
  ...
  it "#==" do
    ...
    expect(described_class.new(1.0, 2.0, 3.0, 4.0)).to eq(QMargins.new(1, 2, 3, 4))
    expect(described_class.new(1.0, 2.0, 3.0, 4.0)).not_to eq(QMargins.new(1, 2, 3, 5))
