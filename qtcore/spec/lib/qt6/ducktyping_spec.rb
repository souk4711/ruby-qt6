RSpec.describe RubyQt6::T do
  ...
  it ".args_nth_to_qanystringview" do
    args = ["abc", "def".to_qstr, QAnyStringView.new("xyz"), 12]
    expect(RubyQt6::T.args_nth_to_qanystringview(args, 0)).to be_a(QAnyStringView)
    expect(RubyQt6::T.args_nth_to_qanystringview(args, 1)).to be_a(QAnyStringView)
    expect(RubyQt6::T.args_nth_to_qanystringview(args, 2)).to be_nil
    expect(RubyQt6::T.args_nth_to_qanystringview(args, 3)).to be_nil
    expect(args[0]).to be_a(QAnyStringView)
    expect(args[1]).to be_a(QAnyStringView)
    expect(args[2]).to be_a(QAnyStringView)
  ...
  it ".args_nth_to_qstr" do
    ...
    expect(RubyQt6::T.args_nth_to_qstr(args, 0)).to be_a(QString)
    expect(RubyQt6::T.args_nth_to_qstr(args, 1)).to be_nil
    expect(RubyQt6::T.args_nth_to_qstr(args, 2)).to be_nil
    expect(args[0]).to be_a(QString)
    expect(args[1]).to be_a(QString)
    expect(args[0].to_s).to eq("abc")
    expect(args[1].to_s).to eq("def")
  ...
  it ".to_qanystringview" do
    o1 = "abc"
    o2 = "def".to_qstr
    o3 = QAnyStringView.new("xyz")
    expect(RubyQt6::T.to_qanystringview(o1)).to be_a(QAnyStringView)
    expect(RubyQt6::T.to_qanystringview(o2)).to be_a(QAnyStringView)
    expect(RubyQt6::T.to_qanystringview(o3)).to be_a(QAnyStringView)
  ...
  it ".to_qstr" do
    o1 = "abc"
    o2 = "def".to_qstr
    expect(RubyQt6::T.to_qstr(o1)).to be_a(QString)
