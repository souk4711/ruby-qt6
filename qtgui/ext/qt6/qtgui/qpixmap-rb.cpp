...
void Init_qpixmap(Rice::Module rb_mQt6QtGui)
{
    rb_cQPixmap =
        ...
        define_class_under<QPixmap, QPaintDevice>(rb_mQt6QtGui, "QPixmap")
            ...
            .define_constructor(Constructor<QPixmap, const char *const[]>(), Arg("xpm"))
            ...
            .define_method("paint_engine", &QPixmap::paintEngine)
            ...
            .define_method("set_mask", &QPixmap::setMask, Arg(""))
            .define_method("size", &QPixmap::size)
            .define_method("to_image", &QPixmap::toImage)
            .define_method("transformed", &QPixmap::transformed, Arg(""), Arg("mode") = static_cast<Qt::TransformationMode>(Qt::FastTransformation))
