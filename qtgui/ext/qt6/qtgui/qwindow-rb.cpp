...
void Init_qwindow(Rice::Module rb_mQt6QtGui)
{
    rb_cQWindow =
        ...
        define_class_under<QWindow, QObject>(rb_mQt6QtGui, "QWindow")
            ...
            // inherits QSurface
            .define_method("format", &QSurface::format)
            .define_method("size", &QSurface::size)
            .define_method("supports_open_gl?", &QSurface::supportsOpenGL)
            .define_method("surface_class", &QSurface::surfaceClass)
            // .define_method("surface_handle", &QSurface::surfaceHandle)
            .define_method("surface_type", &QSurface::surfaceType)
            // Properties
