...
void Init_qtransform(Rice::Module rb_mQt6QtGui)
{
    rb_cQTransform =
        ...
        define_class_under<QTransform>(rb_mQt6QtGui, "QTransform")
            ...
            .define_method<QRect (QTransform::*)(const QRect &) const>("map_rect", &QTransform::mapRect, Arg(""))
            .define_method<QRectF (QTransform::*)(const QRectF &) const>("map_rect", &QTransform::mapRect, Arg(""))
