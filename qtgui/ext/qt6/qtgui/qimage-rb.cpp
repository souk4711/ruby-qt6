...
void Init_qimage(Rice::Module rb_mQt6QtGui)
{
    rb_cQImage =
        ...
        define_class_under<QImage, QPaintDevice>(rb_mQt6QtGui, "QImage")
            ...
            // .define_method("rgb_swap", &QImage::rgbSwap)
            // .define_method<QImage (QImage::*)() const>("rgb_swapped", &QImage::rgbSwapped)
            // .define_method<QImage (QImage::*)()>("rgb_swapped", &QImage::rgbSwapped)
            ...
            .define_method("swap", &QImage::swap, Arg("other"))
