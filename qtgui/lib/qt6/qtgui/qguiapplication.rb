...
module RubyQt6
  module QtGui
    ...
    class QGuiApplication < RubyQt6::QtCore::QCoreApplication
      ...
      # QChronoTimer with 0ns timeout. More advanced idle processing schemes can
      # be achieved using processEvents().
      #
      # We recommend that you connect clean-up code to the aboutToQuit() signal,
      # instead of putting it in your application's main() function. This is
      # because, on some platforms, the QApplication::exec() call may not return.
      def exec
        self.class._exec
      end
    end
