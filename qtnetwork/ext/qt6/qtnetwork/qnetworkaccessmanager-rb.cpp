...
void Init_qnetworkaccessmanager(Module rb_mQt6QtNetwork)
{
    rb_cQNetworkAccessManager =
        ...
        define_class_under<QNetworkAccessManager, QObject>(rb_mQt6QtNetwork, "QNetworkAccessManager")
            ...
            .define_method<void (QNetworkAccessManager::*)(const QString &, quint16, const QSslConfiguration &)>("connect_to_host_encrypted", &QNetworkAccessManager::connectToHostEncrypted, Arg("host_name"), Arg("port") = static_cast<quint16>(443), Arg("ssl_configuration") = static_cast<const QSslConfiguration &>(QSslConfiguration::defaultConfiguration()))
            ...
            .define_method<void (QNetworkAccessManager::*)(std::chrono::milliseconds)>("set_transfer_timeout", &QNetworkAccessManager::setTransferTimeout, Arg("duration") = static_cast<std::chrono::milliseconds>(QNetworkRequest::DefaultTransferTimeout))
