...
append_cppflags("-I#{includedir}/QtNetwork")
abort "libQt6Network is missing, please install qt6-base" unless have_library("Qt6Network")

create_makefile("qt6/qtnetwork/qtnetwork")
