...
void Init_qwebenginepage(Rice::Module rb_mQt6QtWebEngineCore)
{
    rb_cQWebEnginePage =
        ...
        define_class_under<QWebEnginePage, QObject>(rb_mQt6QtWebEngineCore, "QWebEnginePage")
            ...
            .define_method<void (QWebEnginePage::*)(const std::function<void(const QByteArray &)> &, const QPageLayout &, const QPageRanges &)>("print_to_pdf", &QWebEnginePage::printToPdf, Arg("result_callback"), Arg("layout") = static_cast<const QPageLayout &>(QPageLayout(QPageSize(QPageSize::A4), QPageLayout::Portrait, QMarginsF())), Arg("ranges") = static_cast<const QPageRanges &>(QPageRanges {}))
            ...
            .define_method<void (QWebEnginePage::*)(const QString &, const std::function<void(const QVariant &)> &)>("run_java_script", &QWebEnginePage::runJavaScript, Arg("script_source"), Arg("result_callback"))
            // .define_method<void (QWebEnginePage::*)(const QString &, quint32, const std::function<void(const QVariant &)> &)>("run_java_script", &QWebEnginePage::runJavaScript, Arg("script_source"), Arg("world_id") = static_cast<quint32>(0), Arg("result_callback") = static_cast<const std::function<void(const QVariant &)> &>({}))
