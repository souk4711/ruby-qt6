...
void Init_qqmlengine(Rice::Module rb_mQt6QtQml)
{
    rb_cQQmlEngine =
        ...
        define_class_under<QQmlEngine, QJSEngine>(rb_mQt6QtQml, "QQmlEngine")
            ...
            .define_singleton_function("context_for_object", &QQmlEngine::contextForObject, Arg("object"))
            .define_singleton_function("set_context_for_object", &QQmlEngine::setContextForObject, Arg("object"), Arg("context"));
}
